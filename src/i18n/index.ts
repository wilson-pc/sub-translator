    ...
    translation: {
      ...
      edit: {
        ...
        findAndReplace: {
          ...
          replacePlaceholder: "Replace with (leave empty to delete)...",
          ...
          matchesSummary: "{{count}} matches in {{rows}} lines",
          oneMatchSummary: "1 match in 1 line",
          replacedSummary: "Replaced {{count}} occurrence(s) in {{rows}} line(s)",
          close: "Close",
          shortcutHint: "Ctrl+F to search, Ctrl+H to replace",
        },
      },
      legal: {
        terms: {
  ...
  es: {
    translation: {
      ...
      edit: {
        ...
        findAndReplace: {
          toggle: "Buscar y reemplazar",
          findPlaceholder: "Buscar texto...",
          replacePlaceholder: "Reemplazar con (dejar vacio para borrar)...",
          matchCase: "Distinguir mayusculas/minusculas",
          previous: "Coincidencia anterior",
          next: "Siguiente coincidencia",
          replace: "Reemplazar",
          replaceAll: "Reemplazar todo",
          noMatches: "Sin coincidencias",
          matchesSummary: "{{count}} coincidencias en {{rows}} lineas",
          oneMatchSummary: "1 coincidencia en 1 linea",
          replacedSummary: "Se reemplazaron {{count}} ocurrencia(s) en {{rows}} linea(s)",
          close: "Cerrar",
          shortcutHint: "Ctrl+F para buscar, Ctrl+H para reemplazar",
        },
      },
      legal: {
        terms: {
